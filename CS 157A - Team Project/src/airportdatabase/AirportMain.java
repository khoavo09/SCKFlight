...
public class AirportMain {
	...
	public static void mainMenu(Connection connection, String userType) {
			...
			public void actionPerformed(ActionEvent arg1) {
				...
				try {
				    ...
				    okButton.addActionListener(new ActionListener() {
						...
						innerPanel.setLayout(new GridLayout(7,2,5,5));
						...
						JLabel flightType = new JLabel("Flight:");
						JLabel priceLabel = new JLabel("Price: ");
						title.setFont(new Font("Serif", Font.BOLD, 24));
						classType.setFont(new Font("Serif", Font.BOLD, 24));
						flightType.setFont(new Font("Serif", Font.BOLD, 24));
						...
						classPanel.add(classButton1);
						classPanel.add(classButton2);
						classPanel.add(classButton3);
						typePanel.add(flightType);
						typePanel.add(typeButton1);
						typePanel.add(typeButton2);
						buttonPanel.add(innerOkButton);
						buttonPanel.add(innerCancelButton);
						innerPanel.setLayout(new BorderLayout());
						innerPanel.add(titlePanel, BorderLayout.NORTH);
						innerPanel.add(classPanel, BorderLayout.WEST);
						innerPanel.add(typePanel, BorderLayout.EAST);
						...
						innerOkButton.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								JLabel confirmText = new JLabel("Reservation have been confirmed");
								confirmText.setFont(new Font("Serif", Font.BOLD, 24));
								JButton okButton = new JButton("Ok");
								...
								try {
									...
									confirm.setLayout(new BoxLayout(confirm.getContentPane(), BoxLayout.PAGE_AXIS));
				...
				try {
				    ...
				    cancelOKButton.addActionListener(new ActionListener() {
				    	public void actionPerformed(ActionEvent arg0) {
							...
							JLabel cancelText = new JLabel("Reservation have been cancelled");
							cancelText.setFont(new Font("Serif", Font.BOLD, 24));
							JButton okButton = new JButton("Ok");
							...
							try {
								...
								cancel.setLayout(new BoxLayout(cancel.getContentPane(), BoxLayout.PAGE_AXIS));
								cancel.add(cancelText);
								cancel.add(buttonPanel);
								cancel.pack();
				    ...
				    JPanel buttonPanel = new JPanel();
				    buttonPanel.add(cancelOKButton);
				    buttonPanel.add(cancelCancelButton);
				    cancelPanel.add(namePanel);
				    cancelPanel.add(cancelScrollPane);
				    cancelPanel.add(buttonPanel);
				    cancelFrame.add(cancelPanel);
				    cancelFrame.setSize(1200, 300);
		...
		titlePanel1.setLayout(new GridBagLayout());
		titlePanel1.add(title);
		JPanel titlePanel2 = new JPanel();
		titlePanel2.setLayout(new GridBagLayout());
		titlePanel2.add(loggedIn);
